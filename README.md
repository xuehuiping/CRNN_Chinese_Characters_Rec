...
原始仓库地址：https://github.com/Sierkinhane/CRNN_Chinese_Characters_Rec

原始仓库太大，难以clone下来，故手动下载文件并拷贝代码文件。无侵犯之意。

output文件夹见 链接: https://pan.baidu.com/s/14J4KXR44MkSX9mD-8JQ9dg  密码: 98a3
下载之后，解压到仓库根目录

txt文件夹见 链接: https://pan.baidu.com/s/1EnuEwLHomRxf25DhnbET0A  密码: fi97
下载之后，解压到`lib/dataset/`
